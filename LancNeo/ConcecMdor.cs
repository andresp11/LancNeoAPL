...
{
	/// <summary>
	/// Descripción breve de ConcecMdor.
	/// </summary>
	public class ConcecMdor : CatalogoGenerico
	{
        private string IdUsuario;

        private System.Data.SqlClient.SqlDataAdapter sqlDAConecMdor;
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ConcecMdor));
            ...
            // sqlDAConecMdor
            // 
            this.sqlDAConecMdor.DeleteCommand = this.sqlDeleteCommand1;
            this.sqlDAConecMdor.InsertCommand = this.sqlInsertCommand1;
            this.sqlDAConecMdor.SelectCommand = this.sqlSelectCommand1;
            ...
            this.sqlDAConecMdor.UpdateCommand = this.sqlUpdateCommand1;
            // 
            // sqlDeleteCommand1
            // 
            ...
            // sqlSelectCommand1
            // 
            this.sqlSelectCommand1.CommandText = "SELECT     FOLIO, IdObra, ConsObra, FMuestreo, Fensaye, Finforme, NoEco, Semana, " +
    "MuestreadasEn, Observaciones, IdUsuario\r\nFROM         ConecMdor\r\nORDER BY IdObra" +
    ", FOLIO";
    ...
    " Razonsocial.RFC ORDER BY Obra.Idobra";
            ...
            // txtUsrMov
            // 
            this.txtUsrMov.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsConecMdor1, "ConecMdor.IdUsuario", true));
            this.txtUsrMov.Location = new System.Drawing.Point(434, 26);
            ...
            this.label59.Location = new System.Drawing.Point(373, 30);
            ...
            // txtObserva
            // 
            this.txtObserva.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsConecMdor1, "ConecMdor.Observaciones", true));
            ...
            // txtMuestreadasen
            // 
            this.txtMuestreadasen.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsConecMdor1, "ConecMdor.MuestreadasEn", true));
            ...
            // txtSemana
            // 
            this.txtSemana.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsConecMdor1, "ConecMdor.Semana", true));
            ...
            // cmbNoeco
            // 
            this.cmbNoeco.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.dsConecMdor1, "ConecMdor.NoEco", true));
            ...
            this.dtpFinforme.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsConecMdor1, "ConecMdor.Finforme", true));
            ...
            this.dtpFensaye.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsConecMdor1, "ConecMdor.Fensaye", true));
            ...
            this.dtpFmuestreo.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsConecMdor1, "ConecMdor.FMuestreo", true));
            ...
            // txtConsecutivo
            // 
            this.txtConsecutivo.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsConecMdor1, "ConecMdor.ConsObra", true));
            ...
            // cmbIdObra
            // 
            this.cmbIdObra.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.dsConecMdor1, "ConecMdor.IdObra", true));
            ...
            // txtFolio
            // 
            this.txtFolio.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsConecMdor1, "ConecMdor.FOLIO", true));
            ...
            this.DAGeneral = this.sqlDAConecMdor;
            this.dsGeneral = this.dsConecMdor1;
            this.Name = "ConcecMdor";
            this.NombreTabla = "ConecMdor";
            this.Text = "ConcecMdor";
            this.Load += new System.EventHandler(this.ConcecMdor_Load);
		...
		private void ConcecMdor_Load(object sender, System.EventArgs e)
		{
            Control MyControl;
