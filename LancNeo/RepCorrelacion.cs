...
{
	/// <summary>
	/// Descripción breve de RepCorrelacion.
	/// </summary>
	public class RepCorrelacion : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RepCorrelacion));
    ...
    "cretera)";
            ...
            this.panel1.Size = new System.Drawing.Size(1046, 111);
            ...
            this.chbLab.Location = new System.Drawing.Point(402, 76);
            this.chbLab.Name = "chbLab";
            this.chbLab.Size = new System.Drawing.Size(115, 25);
            this.chbLab.TabIndex = 74;
            ...
            this.cbkPrefijo.Location = new System.Drawing.Point(16, 38);
            ...
            this.label6.Location = new System.Drawing.Point(656, 6);
            ...
            this.cmbRes.Location = new System.Drawing.Point(724, 4);
            ...
            this.label11.Location = new System.Drawing.Point(610, 29);
            ...
            this.cmbDiam1.Location = new System.Drawing.Point(724, 27);
            ...
            this.label10.Location = new System.Drawing.Point(610, 54);
            ...
            this.cmbDiam2.Location = new System.Drawing.Point(724, 52);
            this.cmbDiam2.Name = "cmbDiam2";
            this.cmbDiam2.Size = new System.Drawing.Size(68, 21);
            this.cmbDiam2.TabIndex = 35;
            ...
            this.cmbIdObra.Location = new System.Drawing.Point(144, 40);
            ...
            this.label1.Text = "Correlación de cilindros";
            // 
            // Fecha
            // 
            ...
            this.crvRepCorrelacion.Location = new System.Drawing.Point(0, 111);
            ...
            this.crvRepCorrelacion.Size = new System.Drawing.Size(1046, 637);
            ...
            this.crvRepCorrelacion.ToolPanelWidth = 167;
            // 
            // sqlDACorrelacion
            // 
            ...
            // sqlSelectCommand3
            // 
            this.sqlSelectCommand3.CommandText = "[Correlacion]";
            ...
            new System.Data.SqlClient.SqlParameter("@Diam1", System.Data.SqlDbType.Int, 4),
            new System.Data.SqlClient.SqlParameter("@Diam2", System.Data.SqlDbType.Int, 4)});
            // 
            // dsCorrelacion1
            // 
            ...
            this.Name = "RepCorrelacion";
            this.Text = "RepCorrelacion";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.RepCorrelacion_Load);
		...
		private void RepCorrelacion_Load(object sender, System.EventArgs e)
		{
...
//			cmbConcretera.SelectedIndex = 0;
		...
		private void btnVistaPrevia_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				sqlDACorrelacion.SelectCommand.Parameters["@Diam1"].Value = cmbDiam1.SelectedValue;
				sqlDACorrelacion.SelectCommand.Parameters["@Diam2"].Value = cmbDiam2.SelectedValue;
				...
				myPane = new GraphPane( new Rectangle( 10, 10, 10, 10 ),
					"Correlación de envases",
					cmbDiam1.Text + " " + dsDiametro1.Tables[0].Rows[cmbDiam1.SelectedIndex][2] ,
					cmbDiam2.Text + " " + dsDiametro2.Tables[0].Rows[cmbDiam2.SelectedIndex][2] );
				SetSize();
				...
				for( int j = 0; j < i; j++)
				{
					...
					min = (min > xa[j] ? xa[j] : min);
					max = (max < xa[j] ? xa[j] : max);
					min = (min > ya[j] ? ya[j] : min);
					max = (max < ya[j] ? ya[j] : max);
...
//				MessageBox.Show(myPane.XAxis.Type.ToString()); esta buena
...
//				pictureBox1.Image = (Image)myPane.Image.Clone();
