...
{
	/// <summary>
	/// Descripción breve de RepCartaEdadEspecificada.
	/// </summary>
	public class RepCartaEdadEspecificada : System.Windows.Forms.Form
	{
		...
		public RepCartaEdadEspecificada()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RepCartaEdadEspecificada));
    ...
    "cretera)";
            ...
            this.chkMortero.Location = new System.Drawing.Point(899, 104);
            this.chkMortero.Name = "chkMortero";
            this.chkMortero.Size = new System.Drawing.Size(130, 24);
            this.chkMortero.TabIndex = 80;
            ...
            this.chbLab.Location = new System.Drawing.Point(457, 104);
            ...
            this.label12.Text = " Carta Edad Especificada";
            // 
            // cmbPrueba
            // 
            ...
            this.crysRepCartaEdadEspecificada.EnableRefresh = false;
            this.crysRepCartaEdadEspecificada.Location = new System.Drawing.Point(0, 127);
            ...
            this.crysRepCartaEdadEspecificada.Size = new System.Drawing.Size(1028, 534);
            ...
            this.crysRepCartaEdadEspecificada.ToolPanelWidth = 167;
            ...
            // 
            // RepCartaEdadEspecificada
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(1028, 661);
            this.Controls.Add(this.crysRepCartaEdadEspecificada);
            this.Controls.Add(this.panel1);
            this.Name = "RepCartaEdadEspecificada";
            this.Text = "RepCartaEdadEspecificada";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.RepCartaEdadEspecificada_Load);
		...
		private void RepCartaEdadEspecificada_Load(object sender, System.EventArgs e)
		{
...
//				sqlDAMuestras.SelectCommand.Parameters["@IdPlanta"].Value = -1;
                ...
                if (chkMortero.Checked != true)
                {
                    ...
                    SetCrysParams();
                    cryRepCartaEdadEspecificada.SetParameterValue("@Leyenda", chbLeyenda.Checked);
                    cryRepCartaEdadEspecificada.SetParameterValue("@Lab", chbLab.Checked);
                    cryRepCartaEdadEspecificada.SetParameterValue("Unidades", double.Parse(dsUnidad1.Tables[0].Rows[int.Parse(cmbUnidad.SelectedIndex.ToString())][2].ToString()));
		...
		private void SetCrysParams()
		{
            ...
            if  (chkMortero.Checked)
			    pdvRes.Value = resis  + " - " + txtTipo.Text  ;
            else
