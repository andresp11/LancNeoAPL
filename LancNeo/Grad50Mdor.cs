...
{
	/// <summary>
	/// Descripción breve de Grad50Mdor.
	/// </summary>
	public class Grad50Mdor : CatalogoGenerico
	{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Grad50Mdor));
            ...
            new System.Data.SqlClient.SqlParameter("@Original_IdObra", System.Data.SqlDbType.NVarChar, 50, System.Data.ParameterDirection.Input, false, ((byte)(0)), ((byte)(0)), "IdObra", System.Data.DataRowVersion.Original, null),
            new System.Data.SqlClient.SqlParameter("@Original_MuestreadasEn", System.Data.SqlDbType.NVarChar, 50, System.Data.ParameterDirection.Input, false, ((byte)(0)), ((byte)(0)), "MuestreadasEn", System.Data.DataRowVersion.Original, null),
            ...
            new System.Data.SqlClient.SqlParameter("@MuestreadasEn", System.Data.SqlDbType.NVarChar, 50, "MuestreadasEn"),
    ...
    "dNivel, Fechai FROM Laboratorista ORDER BY NoEco";
            ...
            // txtUsrMov
            // 
            this.txtUsrMov.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsGrad50Mdor1, "Grad50Mdor.IdUsuario", true));
            this.txtUsrMov.Location = new System.Drawing.Point(406, 22);
            this.txtUsrMov.Name = "txtUsrMov";
            this.txtUsrMov.ReadOnly = true;
            this.txtUsrMov.Size = new System.Drawing.Size(68, 20);
            this.txtUsrMov.TabIndex = 28;
            // 
            // label11
            // 
            ...
            // txtObserva
            // 
            this.txtObserva.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsGrad50Mdor1, "Grad50Mdor.Observaciones", true));
            ...
            // txtMuestreadasen
            // 
            this.txtMuestreadasen.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsGrad50Mdor1, "Grad50Mdor.MuestreadasEn", true));
            ...
            // txtSemana
            // 
            this.txtSemana.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsGrad50Mdor1, "Grad50Mdor.Semana", true));
            ...
            // cmbNoeco
            // 
            this.cmbNoeco.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.dsGrad50Mdor1, "Grad50Mdor.NoEco", true));
            ...
            this.dtpFinforme.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsGrad50Mdor1, "Grad50Mdor.FInforme", true));
            ...
            this.dtpFensaye.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsGrad50Mdor1, "Grad50Mdor.FEnsaye", true));
            ...
            this.dtpFmuestreo.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsGrad50Mdor1, "Grad50Mdor.FMuestreo", true));
            ...
            // txtConsecutivo
            // 
            this.txtConsecutivo.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsGrad50Mdor1, "Grad50Mdor.ConsObra", true));
            ...
            // cmbIdObra
            // 
            this.cmbIdObra.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.dsGrad50Mdor1, "Grad50Mdor.IdObra", true));
            ...
            // txtFolio
            // 
            this.txtFolio.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsGrad50Mdor1, "Grad50Mdor.FOLIO", true));
            ...
            this.dsGeneral = this.dsGrad50Mdor1;
            this.Name = "Grad50Mdor";
            this.NombreTabla = "Grad50Mdor";
            this.Load += new System.EventHandler(this.Grad50Mdor_Load);
		...
		private void Grad50Mdor_Load(object sender, System.EventArgs e)
		{
            Control MyControl;
