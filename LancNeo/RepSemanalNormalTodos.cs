...
{
	/// <summary>
	/// Descripción breve de RepSemanalNormalTodos.
	/// </summary>
	public class RepSemanalNormalTodos : System.Windows.Forms.Form
	{
		...
		private LancNeo.CryRepSemNormalTodoslogo cryRepSemNormalTodoslogo1;
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RepSemanalNormalTodos));
            ...
            this.cryRepSemNormalTodoslogo1 = new LancNeo.CryRepSemNormalTodoslogo();
...
//			crvRepMuestreador.Visible = false;
		...
		private void btnVistaPrevia_Click(object sender, System.EventArgs e)
		{
            ...
            //CryRepSemNormalTodos1.PrintOptions.PaperOrientation = CrystalDecisions.Shared.PaperOrientation.Landscape;
            //CryRepSemNormalTodos1.SetDataSource(dsRepSemNormal1);
            cryRepSemNormalTodoslogo1.PrintOptions.PaperOrientation = CrystalDecisions.Shared.PaperOrientation.Landscape;
            cryRepSemNormalTodoslogo1.SetDataSource(dsRepSemNormal1);				
...
//				CryRepSemNormalTodos1.DataDefinition.ParameterFields["@Mezcla"].ApplyCurrentValues(pvCollection);
				cryRepSemNormalTodoslogo1.DataDefinition.ParameterFields["@Mezcla"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvFirma1);
//				CryRepSemNormalTodos1.DataDefinition.ParameterFields["@F1"].ApplyCurrentValues(pvCollection);
				cryRepSemNormalTodoslogo1.DataDefinition.ParameterFields["@F1"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvCargo1);
//				CryRepSemNormalTodos1.DataDefinition.ParameterFields["@C1"].ApplyCurrentValues(pvCollection);
				cryRepSemNormalTodoslogo1.DataDefinition.ParameterFields["@C1"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvFirma2);
//				CryRepSemNormalTodos1.DataDefinition.ParameterFields["@F2"].ApplyCurrentValues(pvCollection);
				cryRepSemNormalTodoslogo1.DataDefinition.ParameterFields["@F2"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvCargo2);
//				CryRepSemNormalTodos1.DataDefinition.ParameterFields["@C2"].ApplyCurrentValues(pvCollection);
				cryRepSemNormalTodoslogo1.DataDefinition.ParameterFields["@C2"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvFirma3);
//				CryRepSemNormalTodos1.DataDefinition.ParameterFields["@F3"].ApplyCurrentValues(pvCollection);
				cryRepSemNormalTodoslogo1.DataDefinition.ParameterFields["@F3"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvCargo3);
//				CryRepSemNormalTodos1.DataDefinition.ParameterFields["@C3"].ApplyCurrentValues(pvCollection);
				cryRepSemNormalTodoslogo1.DataDefinition.ParameterFields["@C3"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvFirma4);
//				CryRepSemNormalTodos1.DataDefinition.ParameterFields["@F4"].ApplyCurrentValues(pvCollection);
				cryRepSemNormalTodoslogo1.DataDefinition.ParameterFields["@F4"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvCargo4);
//				CryRepSemNormalTodos1.DataDefinition.ParameterFields["@C4"].ApplyCurrentValues(pvCollection);
				cryRepSemNormalTodoslogo1.DataDefinition.ParameterFields["@C4"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvLogo);
//				CryRepSemNormalTodos1.DataDefinition.ParameterFields["@Ruta"].ApplyCurrentValues(pvCollection);
				cryRepSemNormalTodoslogo1.DataDefinition.ParameterFields["@Ruta"].ApplyCurrentValues(pvCollection);
			}
			catch(Exception ex1)
			{
			...
			try
				...
				else
				{
					...
					sqlDARepSemNormalLogo.SelectCommand.Parameters["@IdReporte"].Value = 5;
 ...
 */
				...
				{
                    //CryRepSemNormalTodos1.SetParameterValue("@F5", dsFirmas1.Tables["Firmas"].Rows[4][1].ToString());
                    //CryRepSemNormalTodos1.SetParameterValue("@C5", dsFirmas1.Tables["Firmas"].Rows[4][2].ToString());
                    //CryRepSemNormalTodos1.SetParameterValue("@Lab", chbLab.Checked);
                    //CryRepSemNormalTodos1.SetParameterValue("@Duplicado", chbDuplicado.Checked);
					
                    //crvRepSemNormal.ReportSource = CryRepSemNormalTodos1;
					//crvRepSemNormal.RefreshReport();
				}
				else
				{
                    cryRepSemNormalTodoslogo1.SetParameterValue("@F5", dsFirmas1.Tables["Firmas"].Rows[4][1].ToString());
                    cryRepSemNormalTodoslogo1.SetParameterValue("@C5", dsFirmas1.Tables["Firmas"].Rows[4][2].ToString());
                    cryRepSemNormalTodoslogo1.SetParameterValue("@Leyenda", chbLeyenda.Checked);
					cryRepSemNormalTodoslogo1.SetParameterValue("@Duplicado", chbDuplicado.Checked);
					cryRepSemNormalTodoslogo1.SetParameterValue("@Lab", chbLab.Checked);
					crvRepSemNormal.ReportSource = cryRepSemNormalTodoslogo1;
					//crvRepSemNormal.RefreshReport();
				}
