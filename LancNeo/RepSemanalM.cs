...
{
	/// <summary>
	/// Descripción breve de RepSemanalNormal.
	/// </summary>
	public class RepSemanalM : System.Windows.Forms.Form
	{
        ...
        private LancNeo.CryRepSemNMllogo cryRepSemNMllogo1;
		private LancNeo.dsRepSemNormalM dsRepSemNormalM1;
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RepSemanalM));
            ...
            this.cryRepSemNMllogo1 = new LancNeo.CryRepSemNMllogo();
            this.dsRepSemNormalM1 = new LancNeo.dsRepSemNormalM();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dsRepSemNormalM1)).BeginInit();
            this.SuspendLayout();
            // 
            // panel1
            // 
            ...
            this.btnVistaPrevia.Location = new System.Drawing.Point(773, 7);
            ...
            this.chbLab.Location = new System.Drawing.Point(97, 76);
            this.chbLab.Name = "chbLab";
            this.chbLab.Size = new System.Drawing.Size(115, 25);
            this.chbLab.TabIndex = 47;
            this.chbLab.Text = "Incluye laboratorio";
            // 
            // chbLeyenda
            // 
            this.chbLeyenda.Location = new System.Drawing.Point(390, 28);
            ...
            this.chbFormato.Location = new System.Drawing.Point(193, 49);
            this.chbFormato.Name = "chbFormato";
            this.chbFormato.Size = new System.Drawing.Size(116, 24);
            this.chbFormato.TabIndex = 28;
            this.chbFormato.Text = "Formato con logo";
            // 
            // chbElemento
            // 
            this.chbElemento.Location = new System.Drawing.Point(217, 76);
            ...
            this.label6.Location = new System.Drawing.Point(647, 55);
            ...
            this.chbImprime.Location = new System.Drawing.Point(4, 28);
            ...
            this.chbRevisa.Location = new System.Drawing.Point(327, 76);
            ...
            this.cmbUnidad.Location = new System.Drawing.Point(543, 55);
            ...
            this.dtpFin.Location = new System.Drawing.Point(543, 31);
            ...
            this.dtpIni.Location = new System.Drawing.Point(543, 7);
            ...
            this.label3.Location = new System.Drawing.Point(513, 7);
            ...
            this.label1.Text = "Reporte semanal normal";
            // 
            // txtIdobra
            // 
            this.txtIdobra.Location = new System.Drawing.Point(468, 48);
            ...
            this.Fecha.Location = new System.Drawing.Point(403, 7);
            ...
            this.cmbConcretera.Location = new System.Drawing.Point(697, 3);
    ...
    "cretera)";
            ...
            // sqlSelectCommand4
            // 
            this.sqlSelectCommand4.CommandText = "[RepSemNormalM]";
    ...
    "aboratorio = @IdLaboratorio)";
            ...
            // sqlCommand2
            // 
            this.sqlCommand2.CommandText = "[RepSemNMLogo]";
            ...
            // sqlSelectCommand9
            // 
            this.sqlSelectCommand9.CommandText = "SELECT IdNorma, Informe, Normas, Titulo, IdInforme, Norma1, Norma3, Norma2, Norma" +
    "4, Norma5 FROM Normas WHERE (IdNorma = @IdNorma) ORDER BY IdNorma";
            ...
            // dsRepSemNormalM1
            // 
            this.dsRepSemNormalM1.DataSetName = "dsRepSemNormalM";
            this.dsRepSemNormalM1.Locale = new System.Globalization.CultureInfo("es-MX");
            this.dsRepSemNormalM1.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // RepSemanalM
            // 
            ...
            this.Name = "RepSemanalM";
            this.Text = "RepSemanalNM";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.RepSemanalM_Load);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dsRepSemNormalM1)).EndInit();
            this.ResumeLayout(false);

		}
		#endregion

		private void RepSemanalM_Load(object sender, System.EventArgs e)
		{
...
//			crvRepMuestreador.Visible = false;
		...
		private void btnVistaPrevia_Click(object sender, System.EventArgs e)
		{
            ...
            cryRepSemNMllogo1.PrintOptions.PaperOrientation = CrystalDecisions.Shared.PaperOrientation.Landscape;
            cryRepSemNMllogo1.SetDataSource(dsRepSemNormalM1);
            //cryRepSemNM1.PrintOptions.PaperOrientation = CrystalDecisions.Shared.PaperOrientation.Landscape;
            //cryRepSemNM1.SetDataSource(dsRepSemNormalM1);				
...
//				cryRepSemNM1.DataDefinition.ParameterFields["@Mezcla"].ApplyCurrentValues(pvCollection);
				cryRepSemNMllogo1.DataDefinition.ParameterFields["@Mezcla"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvFirma1);
//				cryRepSemNM1.DataDefinition.ParameterFields["@F1"].ApplyCurrentValues(pvCollection);
				cryRepSemNMllogo1.DataDefinition.ParameterFields["@F1"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvCargo1);
//				cryRepSemNM1.DataDefinition.ParameterFields["@C1"].ApplyCurrentValues(pvCollection);
				cryRepSemNMllogo1.DataDefinition.ParameterFields["@C1"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvFirma2);
//				cryRepSemNM1.DataDefinition.ParameterFields["@F2"].ApplyCurrentValues(pvCollection);
				cryRepSemNMllogo1.DataDefinition.ParameterFields["@F2"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvCargo2);
//				cryRepSemNM1.DataDefinition.ParameterFields["@C2"].ApplyCurrentValues(pvCollection);
				cryRepSemNMllogo1.DataDefinition.ParameterFields["@C2"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvFirma3);
//				cryRepSemNM1.DataDefinition.ParameterFields["@F3"].ApplyCurrentValues(pvCollection);
				cryRepSemNMllogo1.DataDefinition.ParameterFields["@F3"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvCargo3);
//				cryRepSemNM1.DataDefinition.ParameterFields["@C3"].ApplyCurrentValues(pvCollection);
				cryRepSemNMllogo1.DataDefinition.ParameterFields["@C3"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvFirma4);
//				cryRepSemNM1.DataDefinition.ParameterFields["@F4"].ApplyCurrentValues(pvCollection);
				cryRepSemNMllogo1.DataDefinition.ParameterFields["@F4"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvCargo4);
//				cryRepSemNM1.DataDefinition.ParameterFields["@C4"].ApplyCurrentValues(pvCollection);
				cryRepSemNMllogo1.DataDefinition.ParameterFields["@C4"].ApplyCurrentValues(pvCollection);
				pvCollection.Clear();
				pvCollection.Add(pdvLogo);
//				cryRepSemNM1.DataDefinition.ParameterFields["@Ruta"].ApplyCurrentValues(pvCollection);
				cryRepSemNMllogo1.DataDefinition.ParameterFields["@Ruta"].ApplyCurrentValues(pvCollection);
			}
			catch(Exception ex1)
			{
...
//				{
					...
					sqlDARepSemNormal.Fill(dsRepSemNormalM1, "RepSemNormal");
//				}
//				else
//				{
...
//					sqlDARepSemNormalLogo.SelectCommand.Parameters["@IdReporte"].Value = 1;
...
//				}
				int cuantos = dsRepSemNormalM1.Tables["RepSemNormal"].Rows.Count;
/*				dsLogoLaboratorio1.Clear();
				dsLaboratorio1.Clear();
				sqlDALogoLab.SelectCommand.Parameters["@Idlaboratorio"].Value = dsRepSemNormalM1.Tables["RepSemNormal"].Rows[0]["IdLaboratorio"].ToString();
				...
				ms.Close();
				if(chbLogo.Checked)
					dsRepSemNormalM1.Laboratorio.AddLaboratorioRow(dsRepSemNormalM1.Tables["RepSemNormal"].Rows[0]["IdLaboratorio"].ToString(), arrImage);
				else
					dsRepSemNormalM1.Laboratorio.AddLaboratorioRow(dsRepSemNormalM1.Tables["RepSemNormal"].Rows[0]["IdLaboratorio"].ToString(), null);
*/
...
//				dsRepSemNormal1.Tables["Laboratorio"].Rows[0]["imagen"] = arrImage;
				...
				sqlDANorma.Fill(dsRepSemNormalM1, "Normas");
				if (chbFormato.Checked == false)
				{
                    //cryRepSemNM1.SetParameterValue("@F5", dsFirmas1.Tables["Firmas"].Rows[4][1].ToString());
                    //cryRepSemNM1.SetParameterValue("@C5", dsFirmas1.Tables["Firmas"].Rows[4][2].ToString());
                    //cryRepSemNM1.SetParameterValue("@Lab", chbLab.Checked);
                    //cryRepSemNM1.SetParameterValue("@Duplicado", chbDuplicado.Checked);

                    //crvRepSemNormal.ReportSource = cryRepSemNM1;
//					crvRepSemNormal.RefreshReport();
				}
				else
				{
                    cryRepSemNMllogo1.SetParameterValue("@F5", dsFirmas1.Tables["Firmas"].Rows[4][1].ToString());
                    cryRepSemNMllogo1.SetParameterValue("@C5", dsFirmas1.Tables["Firmas"].Rows[4][2].ToString());
                    cryRepSemNMllogo1.SetParameterValue("@Leyenda", chbLeyenda.Checked);
					cryRepSemNMllogo1.SetParameterValue("@Duplicado", chbDuplicado.Checked);

					cryRepSemNMllogo1.SetParameterValue("@Lab", chbLab.Checked);
					crvRepSemNormal.ReportSource = cryRepSemNMllogo1;
//					crvRepSemNormal.RefreshReport();
				}
			}
			catch(Exception ex)
